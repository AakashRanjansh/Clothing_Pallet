...
$product_price = "<del> NPR$pro_price </del>";

$product_psp_price = "| NPR$pro_psp_price";
...
function getProductsmen(){
    ...
    /// getProductsmen function Code Starts ///
    ...
    $get_products = "select * from products where cat_id=5 ".$sWhere;
...
function getProductswomen(){
  ...
  $get_products = "select * from products where cat_id=2 ".$sWhere;
...
function getProductskids(){
  ...
  $get_products = "select * from products where cat_id=3 ".$sWhere;
